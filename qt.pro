...
isEmpty(BDB_LIB_PATH) {
    ...
    windows:BDB_LIB_PATH=C:/TKZ/coindeps32/bdb-4.8/lib
}
...
isEmpty(BDB_INCLUDE_PATH) {
    ...
    windows:BDB_INCLUDE_PATH=C:/TKZ/coindeps32/bdb-4.8/include
}

isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /usr/local/Cellar/boost/1.59.0/lib
    windows:BOOST_LIB_PATH=C:/TKZ/coindeps32/boost_1_57_0/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/Cellar/boost/1.59.0/include
    windows:BOOST_INCLUDE_PATH=C:/TKZ/coindeps32/boost_1_57_0/include
}
...
isEmpty(MINIUPNPC_INCLUDE_PATH) {
    ...
    windows:MINIUPNPC_INCLUDE_PATH=C:/TKZ/coindeps32/miniupnpc-1.9
}

isEmpty(MINIUPNPC_LIB_PATH) {
    macx:MINIUPNPC_LIB_PATH=/usr/local/Cellar/miniupnpc/1.9.20151008/lib
    windows:MINIUPNPC_LIB_PATH=C:/TKZ/coindeps32/miniupnpc-1.9
}

isEmpty(OPENSSL_INCLUDE_PATH) {
    macx:OPENSSL_INCLUDE_PATH = /usr/local/openssl-1.0.1p/include
    windows:OPENSSL_INCLUDE_PATH=C:/TKZ/coindeps32/openssl-1.0.1p/include
}

isEmpty(OPENSSL_LIB_PATH) {
    macx:OPENSSL_LIB_PATH = /usr/local/openssl-1.0.1p/lib
    windows:OPENSSL_LIB_PATH=C:/TKZ/coindeps32/openssl-1.0.1p/lib
}
