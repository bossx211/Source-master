// Copyright (c) 2014-2015 The Darkcoin TKZelopers
...
/* *** BEGIN DARKSEND MAGIC - DASH **********
    Copyright (c) 2014-2015, Dash TKZelopers
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat testkoinz and make it unusable. To
...
bool CDarksendPool::DoAutomaticDenominating(bool fDryRun)
{
    ...
    CAmount nBalanceNeedsAnonymized = nAnonymizetestkoinzAmount*COIN - pwalletMain->GetAnonymizedBalance();
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("testkoinz-darksend");
