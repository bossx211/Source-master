...
public:
  /*!
    ...
    depending on whether they are wanted on the respective output TKZice.
  */
  enum PainterMode { pmDefault       = 0x00   ///< <tt>0x00</tt> Default mode for painting on screen TKZices
  ...
  QCPPainter();
  QCPPainter(QPaintTKZice *TKZice);
  ~QCPPainter();
  ...
  bool begin(QPaintTKZice *TKZice);
  void setPen(const QPen &pen);
